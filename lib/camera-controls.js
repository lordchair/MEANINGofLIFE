...
(function (global, factory) {
	...
	var CameraControls = function () {
		...
		function CameraControls(object, domElement, rotateSpeed) {
			...
			this.zoomSpeed = 1.0;
      this.rotateSpeed = rotateSpeed || 1.0;
				...
				var _dragging = function _dragging(event) {
					...
					switch (state) {
						...
						case STATE.TOUCH_ROTATE:
							...
							var rotX = 2 * Math.PI * deltaX / elementRect.width * rotateSpeed;
							var rotY = 2 * Math.PI * deltaY / elementRect.height * rotateSpeed;
